...
async def save_img(image_name, result):
    return plt.imsave(image_name, result.permute(2,3,1,0).detach().cpu().numpy()[:,:,:,0])
...
class StyleTransfer():
    ...
    def __init__(self, content_img, style_img, input_img):
    ...
    def get_style_model_and_losses (self, cnn, content_img, style_img,
                               normalization_mean,
                               normalization_std,
        ...
        normalization = self.Normalization(self.normalization_mean, self.normalization_std).to(self.device)
    ...
    def get_input_optimizer(self,input_img):
        ...
        self.optimizer = optim.LBFGS([input_img.requires_grad_()], lr=1)
        return self.optimizer

    def run_style_transfer(self, num_steps=150, style_weight=1000000, content_weight=1):
        ...
        while run[0] <= num_steps:
            ...
            def closure():
                ...
                return style_score + content_score #style_score_sum + content_score #style_score2 + content_score
